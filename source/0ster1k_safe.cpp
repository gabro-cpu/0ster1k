...
int main() {
    PrepareAudio();
    if (MessageBoxW(NULL, L"This software is NOT considered malware.\n This is a safe version of 0ster1k.exe, it doesn't have the second warning. Proceed?", L"0ster1k_GDI-Only.exe", MB_YESNO | MB_ICONEXCLAMATION) == IDNO)
    {
        ExitProcess(0);
    }
    else {
